...
use crate::create_py_repl_reset_tool;
use crate::create_py_repl_tool;
...
pub fn build_tool_registry_plan(
    ...
    if config.py_repl_enabled {
        ...
        plan.register_handler("py_repl", ToolHandlerKind::PyRepl);
        plan.register_handler("py_repl_reset", ToolHandlerKind::PyReplReset);
    }
