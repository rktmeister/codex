...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "copy_code", "Select a fenced code block from the latest response and copy it."),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("global", "copy_code") => Some(runtime_keymap.app.copy_code.as_slice()),
